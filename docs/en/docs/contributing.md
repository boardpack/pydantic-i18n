...
* Check in the <a href="https://github.com/boardpack/pydantic-i18n/issues" class="external-link" target="_blank">issues</a> to see if there's one coordinating translations for your language.
