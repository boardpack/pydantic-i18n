"""Lightweight version of docs.py script for pydantic-i18n package
...
def build_lang(
    ...
    # Exclude first 2 entries pydantic-i18n and Languages, for custom handling
    use_nav = nav[2:]
...
def update_config(lang: str):
    ...
    original_languages: Dict[str, str] = {
        re.sub("[^a-z]", "", lang["link"]) or "en": lang["name"]
